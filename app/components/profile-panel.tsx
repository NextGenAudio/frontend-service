...
export function ProfilePage() {
  ...
  const userPlaylists = [
    ...
    { name: "Chill Vibes", songCount: 32, image: "/chill-music-playlist.png" },
    {
      name: "Workout Mix",
      songCount: 28,
      image: "/workout-music-playlist.png",
    },
    {
      name: "Late Night",
      songCount: 19,
      image: "/late-night-music-playlist.png",
    },
  ];
              ...
              <div key={index} className="group cursor-pointer">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 hover:bg-white/20 transition-all duration-300 hover:shadow-2xl">
                  <div className="relative mb-4">
                    ...
                    <Button
                      size="icon"
                      className={`absolute bottom-2 right-2 bg-gradient-to-r ${theme.preview} hover:${themeColors.gradient} text-white rounded-full w-12 h-12 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 shadow-lg`}
                    >
