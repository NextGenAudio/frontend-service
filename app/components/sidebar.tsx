      ...
      <div className="absolute top-0 left-0 h-screen rounded-[32px] w-32 items-center flex flex-col justify-between py-6 pr-5">
          ...
          {menuItems.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute left-full ml-3 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-black/90 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none whitespace-nowrap z-50 group-hover:translate-x-1 backdrop-blur-sm border border-white/10 shadow-lg">
                  {item.label}
        ...
        <div className="mt-auto mb-4">
          <button
            ...
            className="group w-10 h-10 rounded-full bg-white/20 backdrop-blur-md border border-white/20 overflow-hidden hover:scale-110 active:scale-95 transition-all duration-300 hover:bg-white/30 hover:border-white/30 hover:shadow-lg hover:shadow-orange-500/20 focus:outline-none focus:ring-2 focus:ring-white/30 focus:ring-offset-2 focus:ring-offset-transparent cursor-pointer"
          >
