...
import { Search, FolderOpen, Play, Heart } from "lucide-react";
...
export function SearchBar() {
  ...
  return (
    <div className="mx-4 relative" ref={searchRef}>
      <div className="flex items-center gap-4 bg-slate-700/40 backdrop-blur-xl border border-white/10 rounded-xl px-3 py-2 shadow-2xl">
        ...
        <div className="flex-1 flex items-center gap-3">
          ...
          <input
            ...
            onFocus={() =>
              searchValue && setShowSuggestions(suggestions.length > 0)
            }
      ...
      {showSuggestions && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl z-50 max-h-96 overflow-y-auto">
